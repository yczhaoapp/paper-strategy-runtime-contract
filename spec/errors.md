...
- 数据与源码完整性：`DATA_STREAM_MISSING`、`DATA_KIND_MISMATCH`、`DATA_FIELD_MISSING`、`DATA_TIMEFRAME_MISMATCH`、`DATA_RECORD_COUNT_MISMATCH`、`DATA_STALENESS_EXCEEDED`、`DATA_ORDERING_INVALID`、`DATA_HASH_MISMATCH`、`SOURCE_HASH_MISMATCH`、`TRAINING_DATA_MISMATCH`；
- 映射与上下文：`SYMBOL_MAPPING_FAILED`、`ENGINE_CAPABILITY_UNSUPPORTED`、`EXECUTION_CONTEXT_MISMATCH`；
